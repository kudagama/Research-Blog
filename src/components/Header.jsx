  ...
  return (
    <header className="header">
      <div className="header-content">
        <div>
          <h1>Research Blog</h1>
          <div className="header-subtitle">Exploring innovative solutions through research</div>
        </div>
        <button 
